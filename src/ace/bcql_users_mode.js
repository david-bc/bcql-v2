...
ace.define('ace/mode/bcql_users_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], function(acequire, exports, module) {
  let oop = acequire('../lib/oop');
  ...
  let EikelangHighlightRules = function() {
    let builtins = 'AND|OR|Firstname|Lastname|Email';
...
ace.define('ace/mode/bcql_users', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/bcql_users_highlight_rules'],
  function(acequire, exports, module) {
    let oop = acequire('../lib/oop');
    let TextMode = acequire('../mode/text').Mode;
    let EikelangHighlightRules = acequire('./bcql_users_highlight_rules').EikelangHighlightRules;
